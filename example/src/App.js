...
const App = () => {
  ...
  const fields = [
    ...
    },
    {
      ...
      elementProps: {
        ...
        handleChange: (file, index) =>
          handleUploadChange('idCard', file, index),
    ...
    },
    {
      ...
      description:
        '一个店铺只能选择一个主营类目,普通类目入驻后，可以补充资质申请其他类目'
    },
    {
      name: 'sex',
      label: '性别',
    ...
    },
    {
      ...
      elementProps: {
        ...
        handleChange: (file, fileList) =>
          handleGalleryChange('car', file, fileList)
      },
      itemProps: {
